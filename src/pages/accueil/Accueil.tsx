	...
	return (
		<>
			...
			<p className="Message-accueil">
				...
				dieu en quête de la muse parfaite, vous trouverez votre moitié divine
				parmi les immortels. Prêt à faire briller l’amour sous le regard des
				étoiles ? Rejoignez-nous dès aujourd’hui !
			</p>
		</>
	);
}
